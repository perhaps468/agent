...
@EnableConfigurationProperties(RocketMQTransactionProperties.class)
...
public class RocketMQAutoConfiguration {
    ...
    @Bean
    public TransactionProducerTemplate transactionProducerTemplate() {
        return new TransactionProducerTemplate(rocketMQTemplate);
    }
}
